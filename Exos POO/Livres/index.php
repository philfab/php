...
// Création de livres
$l1 = new Livre("Ca", $auteur, 1138, 20, "1986-01-01");
$l2 = new Livre("Simetierre", $auteur, 374, 15, "1983-01-01");
$l3 = new Livre("Le Fléau", $auteur, 823, 14, "1978-01-01");
$l4 = new Livre("Shining", $auteur, 447, 16, "1977-01-01");
